...
```bash
flutter pub add drift:^2.20.0 drift_flutter:^0.2.0 flutter_riverpod:^2.6.1 pdf:^3.11.0 printing:^5.13.0 intl:^0.19.0
flutter pub add dev:drift_dev:^2.20.0 dev:build_runner:^2.4.0 dev:sqlite3:^2.4.0
